...
public class PreferencesManager {
    ...
    public int sr_duration_on, sr_duration_off, sr_duration_afterCue, sr_num_stim, sr_locations;

    public void SpatialResponse() {
        sr_duration_afterCue = sharedPrefs.getInt(r.getString(R.string.preftag_sr_duration_afterCue), r.getInteger(R.integer.default_sr_duration_afterCue));;
    ...
    public void ObjectDiscrim() {
        od_start_delay = sharedPrefs.getInt(r.getString(R.string.preftag_od_startDelay), r.getInteger(R.integer.default_od_startDelay));
    ...
    public int dnts_duration_on, dnts_duration_off, dnts_num_stim, dnts_num_distractors, dnts_start_delay;

    public void DelayedNonmatchToSample() {
        dnts_start_delay = 500;
        dnts_duration_off = sharedPrefs.getInt(r.getString(R.string.preftag_od_duration_off), r.getInteger(R.integer.default_od_duration_off));
        dnts_duration_on = sharedPrefs.getInt(r.getString(R.string.preftag_od_duration_on), r.getInteger(R.integer.default_od_duration_on));
        dnts_num_distractors = 1;
        dnts_num_stim = 1;
    }
